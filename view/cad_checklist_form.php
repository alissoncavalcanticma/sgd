                                                        ...
                                                        <div class="row" style="margin-bottom: 7px">
                                                            ...
                                                            <!-- TURNO -->
                                                                <div class="col-md-4" style="float: left">
                                                                    <select autofocus tabindex="1" style="background-color: #E9ECEF; font-weight: bold; font-size: 14px; border: 0px" name="turno" class="form-control text-center"  required oninvalid="setCustomValidity('Selecione o turno')" onchange="try{setCustomValidity('')}catch(e){}">
                                                                ...
                                                                <?php
                                                                  ...
                                                                  ?>
                                                                  <input tabindex="-1" type="datetime"  id="data" name="data"
